...
<Navbar/>
    <v-content>
      ...
      <v-flex justify-center>
                <div class="tes">Developers Team</div>
          <!--<p class="headline text-center dev-text"></p>-->
      </v-flex>
       </v-parallax>
...
<style scoped>
    .tes{
        ...
        15px 15px 5px #46b59b,
        20px 20px 5px #017e7f,
        25px 25px 5px #052939,
        30px 30px 5px #c11a2b,
        35px 35px 5px #c11a2b;
    }
.main-content
{
